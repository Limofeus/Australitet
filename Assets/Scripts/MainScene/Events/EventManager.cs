...
public class EventManager : MonoBehaviour
{
    ...
    { 
        ...
        new KrisyBigEvent("Нашествие крыс", "Крысы поедают наши запасы. Страдают от голода невинные дети и старики.  Можем отравить еду, но тогда после смерти крыс она будет непригодной или изготовить металлическое оружие, потратив металл.", 2, "Изготовить оружие", "Отравить"),
        new KrotBigEvent("Прорыв Кротов", "Кроты мешают работе всего королевства и дестабилизируют опоры наших комнат. Произошло уже несколько небольших завалов, к счастью, без жертв. Можем облицевать комнаты металлом и кроты к нам не доберутся или убить их руками что может вызвать болезни.", 3, "Укрепить пещеры", "Убить руками")
    };
